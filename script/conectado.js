...
if (usuarioLogado) {
  // Usa só o primeiro nome na mensagem de boas-vindas
  const primeiroNome = usuarioLogado.nome.split(" ")[0];

  document.getElementById("nomeUsuario").textContent = primeiroNome;
  document.getElementById("dadoNome").textContent = usuarioLogado.nome;
  document.getElementById("dadoEmail").textContent = usuarioLogado.email;

  // Preenche o menu do usuário (avatar com iniciais + nome + e-mail)
...
function sair() {
  // Apaga a sessão salva no navegador
